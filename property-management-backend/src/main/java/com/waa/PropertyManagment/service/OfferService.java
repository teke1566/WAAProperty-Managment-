    ...
    * */
    ...
    public ByteArrayInputStream generateReceipt(Long offerId) throws DocumentException{
        ...
        if(offerOptional.isPresent()){
            ...
            Paragraph paragraph1=new Paragraph("Offered By: "+offer.getUser().getUsername());
            Paragraph paragraph2=new Paragraph("Property Name: "+offer.getProperty().getName(),font);
